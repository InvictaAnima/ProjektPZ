...
public class Settings {
	public static ArrayList<String> variablesToDisplay; // zawiera nazwy
														// argumentow do
														// wyswietlenia w tabeli
	public static ArrayList<String> invalidVariablesToDisplay; // wprowadzone
																// przez
																// uzytkowanika
